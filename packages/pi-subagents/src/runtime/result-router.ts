...
import {
	...
	formatSessionRef,
} from "./final-context-usage.js";
import { outstandingWork } from "./outstanding-work.js";
import { releaseSpawnWidthSlot } from "./spawn-width.js";
import {
...
export function deliverCompletedSubagentResult(
	...
	outstandingWork.delivery(completed.id, () =>
		pi.sendMessage(
			{
...
function getCompletedContextReference(completed: CompletedSubagentResult): string {
	return completed.reportContextUsage === false
...
function deliverSubagentPing(
	...
	const sessionRef = result.sessionFile
		...
		: "";
	outstandingWork.delivery(running.id, () =>
		pi.sendMessage(
			{
