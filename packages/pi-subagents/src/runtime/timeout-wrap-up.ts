...
import { buildResumePiArgs, getResumeCwd } from "../launch/resume.js";
...
import { closeSurfaceAsync } from "../mux/io.js";
...
import { createSurface, getMuxBackend, sendShellCommand } from "../mux.js";
import { clearSubagentExitSidecar } from "../session/exit-sidecar.js";
import { getDoneSentinelFile } from "../session/session-files.js";
import {
...
import { SPAWNING_TOOL_NAMES } from "../tools/tool-names.js";
import type { RunningSubagent } from "../types.js";
	...
	if (running.mode === "background") {
		...
		const child = spawn(invocation.command, invocation.args, {
			...
			env: getSubagentChildProcessEnv(
				invocation,
				launch.env,
				resolveDenyEnvPatterns(running.launchMetadata?.denyEnv),
			),
		});
