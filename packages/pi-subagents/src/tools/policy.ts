...
import { isSetTabTitleToolEnabled } from "../agents/titles.js";
import { markSubagentBatchBlocking } from "../runtime/state.js";
...
export function getBackgroundAutoExitWarning(
	...
	return {
		...
		suggestion: "true",
		message:
			"Warning: background launches always use auto-exit: true; auto-exit: false is ignored.",
	};
}
...
export function applySynchronousLaunchPolicy(
	...
	return (usesBackgroundLaunch || forceSynchronousLaunch) && agentDefs?.autoExit !== true
		? true
		: undefined;
}
