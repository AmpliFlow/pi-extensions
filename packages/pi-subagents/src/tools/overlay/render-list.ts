...
import type { OverlayItem, OverlayState, TabId, Theme } from "./render-types.js";
...
const EMPTY_MESSAGES: Record<TabId, string[]> = {
	...
	orchestrator: [
		"Orchestrator controls are unavailable.",
		"Return to the parent session to change orchestration.",
	],
};
