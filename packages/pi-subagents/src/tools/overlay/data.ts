...
import { stopRunningSubagent } from "../../runtime/wiring.js";
import { getEntries } from "../../session/session.js";
import {
...
import { compactCount, firstLine, formatElapsed, formatElapsedSeconds } from "./render-helpers.js";
import type { DetailSection, OverlayContext, OverlayItem } from "./render-types.js";
...
function recoverResultDetails(entry: {
	[key: string]: unknown;
