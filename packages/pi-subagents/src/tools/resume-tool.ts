...
import { shouldAwaitSubagentLaunch } from "../runtime/running-registry.js";
import {
	getSubagentBatchStopMetadata,
	markSubagentBatchBlocking,
	requestSubagentBatchStop,
} from "../runtime/state.js";
import { endedUnderContextPressure } from "../session/completion-reason.js";
import { readSubagentLaunchMetadata } from "../session/session-files.js";
import { readSubagentTimeoutSidecar } from "../session/timeout-sidecar.js";
import type { RunningSubagent, SubagentResult } from "../types.js";
import { formatTaskPreview, renderSubagentCompletionText } from "./message-renderers.js";
import { shouldForceSynchronousLaunch } from "./subagent-tools.js";
import { SUBAGENT_RESUME_TOOL_NAME } from "./tool-names.js";
...
function assertResumeAllowed(sessionFile: string): void {
	...
	const limitDescription =
		timedOut.kind === "idle-timeout" ? "limit for time without output" : "time limit";
	throw new Error(
