...
import { stripInternalLaunchOverrides } from "../launch/launch-overrides.js";
import {
...
import { findRunningSubagent } from "../runtime/running-registry.js";
import {
	claimSpawnWidthSlot,
	getLiveSlotCount,
	getSpawnWidthLimit,
...
import { parseSpawnEnv, resolveSpawnPolicy } from "../spawn/policy.js";
import type { RunningSubagent, SubagentParamsInput, SubagentResult } from "../types.js";
import { resolveVerifierCandidateCount } from "../vf/criteria.js";
import { launchVerifiedFanOut } from "../vf/run/launch.js";
...
import { registerSetTabTitleTool } from "./set-tab-title.js";
import {
				...
				const prepared = children.map((child) => {
					...
					return {
						...
						warning:
							...
							getBackgroundAutoExitWarning(
								agentDefs,
								shouldUseBackgroundLaunch(child, agentDefs, ctx.hasUI),
							),
					};
				});
