...
import { getPublishedRunningSubagentCount } from "../runtime/nested-lifecycle.js";
import {
	createCallerPingState,
	rearmCallerPingExitAfterReenable,
	registerCallerPingTool,
	suppressCallerPingExit,
} from "./caller-ping.js";
import { applyChildSystemPromptOverrides } from "./child-system-prompt.js";
import { installSubagentContextReminders } from "./context-reminders.js";
import { createExitSignalWriter } from "./exit-signal.js";
import { type FinalContextSnapshot, getFinalContextSnapshot } from "./final-context-snapshot.js";
import { isMissingOptionalDependency, optionalRequire } from "./optional-dependency.js";
import {
	ProviderErrorRecoveryController,
	resolveProviderRecoveryDelaysMs,
} from "./provider-error-recovery.js";
import { registerSetTabTitleTool, shouldRegisterSetTabTitleTool } from "./set-tab-title.js";
import { installSubagentTimeoutReminders } from "./timeout-reminders.js";
import { SUBAGENT_DONE_TOOL_NAME, SUBAGENT_LAUNCH_TOOL_NAMES } from "./tool-names.js";
