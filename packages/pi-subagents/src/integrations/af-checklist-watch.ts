...
const CHECKLIST_AGENT_DEFAULTS: AgentDefaults = {
	...
	body: [
		...
		"Do not ask for approval of safe, reversible choices or ordinary wording preferences. Use your best judgment unless the checklist or a higher-priority rule requires a human decision.",
		"Before a mandatory human decision, prepare the complete exact artifact and ask one consolidated question for all currently known dependent choices. Do not ask separate title, body, audience, or similar preference questions.",
		"Treat a continuation handover as the context for the answer. Preserve the exact artifact across fresh worker processes; after an answer, continue the unblocked work instead of redrafting or repeating the question.",
