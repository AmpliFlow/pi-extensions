import { formatTimeoutSeconds } from "../runtime/timeout-budget.js";
import {
...
import type { ResolvedAgentDefinition } from "./definitions.js";
import { getEffectiveAgentDefinitions } from "./definitions.js";
import { buildModelRef, parseAllowedModels } from "./model-refs.js";
...
function getToolReturn(
	entry: AgentListEntry,
	awaitAllLaunches: boolean,
): "wait_here" | "later_message" {
