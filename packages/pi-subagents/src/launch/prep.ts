...
import { parseSpawnEnv, resolveSpawnPolicy, type SpawnPolicyResult } from "../spawn/policy.js";
import {
	PI_SUBAGENT_CONTEXT_WARN_STEP,
	PI_SUBAGENT_CONTEXT_WARN_THRESHOLD,
} from "../tools/context-reminders.js";
import { getSubagentToolLaunchArgs } from "../tools/policy.js";
import {
...
import type { RunningSubagent, SubagentParamsInput } from "../types.js";
import { buildAppendSystemInheritancePlan } from "./append-system.js";
import { parseCommandWords } from "./child-command.js";
import { buildChildLaunchPlan, type ModelRegistryLike } from "./child-launch-plan.js";
import { CHILD_CONTEXT_BOUNDARY_SYSTEM_PROMPT } from "./context-boundary.js";
import { parseEnvString } from "./env.js";
import { getLaunchEnvCollisions } from "./launch-overrides.js";
import {
...
import type { ResumeMode } from "./resume.js";
import { type ResolvedSubagentRuntimePaths, resolveSubagentCwd } from "./runtime-paths.js";
import { PI_SUBAGENT_SKILL_VISIBILITY } from "./skill-visibility.js";
import { buildSkillLaunchPlan, formatInjectedSkills, type SkillLaunchPlan } from "./skills.js";

export {
	normalizeModelRef,
	resolveAvailableModelRef,
	splitModelRefThinking,
} from "./child-launch-plan.js";
...
export async function prepareSubagentLaunch(
	...
	const agentDefs = ctx.agentDefaultsOverride
		? { ...ctx.agentDefaultsOverride }
		: params.agent
