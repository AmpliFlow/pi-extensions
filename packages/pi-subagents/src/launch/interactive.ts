...
import { getSubagentDisplayTitle, isSetTabTitleToolEnabled } from "../agents/titles.js";
...
import { buildPiPromptArgs, getDoneSentinelFile } from "../session/session-files.js";
import { getSubagentToolLaunchArgs } from "../tools/policy.js";
import { PI_SUBAGENT_TIMEOUT_STARTED_AT } from "../tools/timeout-reminders.js";
import { SET_TAB_TITLE_TOOL_NAME } from "../tools/tool-names.js";
...
import { coordinateSubagentLaunch } from "./launch-coordinator.js";
import {
...
import { writeSystemPromptArtifact, writeTaskArtifact } from "./prompt-artifacts.js";
import { buildInteractiveShellCommand } from "./shell-command.js";
import { expandSubagentTask } from "./task-expansion.js";
import { traceSubagentLaunch } from "./trace.js";
