...
import type { PreparedSubagentLaunch } from "./prep.js";
import { resolveSubagentCwd } from "./runtime-paths.js";
 ...
 */
export function resolveForcedChildCwd(
	overrides: LaunchRuntimeOverrides,
	sourceCwd: string,
): string | undefined {
