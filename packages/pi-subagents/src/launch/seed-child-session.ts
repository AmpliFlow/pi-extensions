...
import type { SubagentSessionMode } from "../session/session-files.js";
import type { SubagentParamsInput } from "../types.js";
import { buildChildContextBoundary, isChildContextBoundaryDisabled } from "./context-boundary.js";
import type { PreparedSubagentLaunch, SubagentLaunchContext } from "./prep.js";
...
export function seedPreparedSubagentSession(
	...
	if (seedMode) {
		...
		storage.seed(
			...
			forcedCwd ?? prepared.runtimePaths.effectiveCwd ?? ctx.cwd,
			{
